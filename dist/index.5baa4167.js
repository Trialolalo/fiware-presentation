...
if (!user) window.location.href = 'http://localhost:8282/realms/Anysolution/protocol/openid-connect/auth?client_id=Data_visualization&redirect_uri=http://localhost:3200&response_type=code&scope=openid';
